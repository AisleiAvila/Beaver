...
public interface ChatApi {
    ...
    /**
     * POST /chat/generate : Generate endpoint
     * Endpoint para gerar resposta baseada no modelo e prompt fornecidos.
     *
     * @param chatRequestDTO  (required)
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "Sucesso", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = ChatResponseDTO.class))
            })
        }
    )
    @RequestMapping(
    ...
    ResponseEntity<ChatResponseDTO> generate(
        @Parameter(name = "ChatRequestDTO", description = "", required = true) @Valid @RequestBody ChatRequestDTO chatRequestDTO
    );
